...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 25px | 1.5 | 25px | 33px |
| 見出し | 19px | 1.5 | 121px | 21px |
| 本文 | 17px | 1.75 | 36px | 31px |
| 補助 | 16px | — | — | — |
| 注記 | 15px | — | — | — |
...
- 使われている面の色: `#ffffff`（28） / `#00175c`（8） / `#6194d3`（7） / `#12286a`（3）
- 見出しは左4／中央5。
...
- 91枚使っている。うち 2 枚は画面いっぱいに置く
- 比率は 16:9（32枚）、3:4（30枚）、1:1（24枚）
- 角丸 0px。切り抜かず四角のまま置く
