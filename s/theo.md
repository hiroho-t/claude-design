...
- 欧文: Lato
- ウェイトは 800 / 700 / 400 / 600 が中心。太さで強弱をつけず、大きさで差をつける。

| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 20px | 1.5 | 64px | 56px |
| 見出し | 18px | 1.5 | 158px | 24px |
| 本文 | 16px | 1.5 | 116px | 40px |
| 補助 | 14px | 1.71 | 3px | 321px |
| 注記 | 13px | — | — | — |
