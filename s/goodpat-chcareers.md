...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 32px | 1.2 | 206px | 24px |
| 見出し | 18px | — | — | — |
| 小見出し | 16px | 1.5 | 275px | 8px |
| 本文 | 15px | 1.5 | 34px | 8px |
| 補助 | 14px | 1.7 | 240px | 0px |
| 注記 | 13px | — | — | — |
...
角丸は 12px だが、**完全な円は別扱い**で 67 箇所ある（24px×66、32px×1）。
