...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 34px | 1.6 | 100px | 57px |
| 見出し | 23px | 1 | 97px | 12px |
| 小見出し | 22px | 1 | 16px | 13px |
| リード | 20px | 1 | 13px | 12px |
| 本文 | 12px | — | — | — |
| 補助 | 11px | — | — | — |
...
小さいラベルを見出しの上に置く型を 2箇所で使っている（見出し7箇所のうち）。
...
```css
.c-head__label{ font-size:12px; font-weight:400; letter-spacing:0.02em;
  color:#555555 }
.c-head__title{ font-size:22px; line-height:1; margin-top:13px }
.c-head + *{ margin-top:13px }
```

- ラベルと見出しの間は 13px、見出しと本文の間は 13px。この2つを同じにしない。
...
.c-head__label{ font-size:12px; font-weight:400; letter-spacing:0.02em; color:#555555 }
.c-head__title{ font-size:22px; line-height:1; margin-top:13px }
.c-head + *{ margin-top:13px }
