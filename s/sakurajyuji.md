...
文字色は `#333333` / `#ffffff` / `#555555` / `#ff1f54`。
...
- `#ff1f54` は文字色として4箇所で使うのが主。面としては0箇所しかないが、1枚が大きく画面の0%を占める。ボタンの地には使っていない。
...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 18px | 1.4 | 180px | 87px |
| 見出し | 16px | — | — | — |
| 小見出し | 15px | 1.65 | 60px | 31px |
| リード | 14px | — | — | — |
| 本文 | 13px | 1.6 | — | — |
| 補助 | 12px | — | — | — |
| 注記 | 11px | — | — | — |
...
| 2 | 1040px | — | 5カラム・画像あり | 左 | 見出しの下 |
| 3 | 400px | — | 3カラム・画像あり | 左 | — |
| 4 | 520px | — | 2カラム・画像あり | 左 | 見出しの下 |
| 5 | 520px | — | 6カラム・画像あり | 左 | 見出しの下 |
| 6 | 1480px | — | 6カラム・画像あり | 左 | 見出しの下 |
| 7 | 240px | — | 4カラム・画像あり | 左 | 見出しの下 |
