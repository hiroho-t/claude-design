...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 36px | 1.5 | 141px | 103px |
| 見出し | 20px | — | — | — |
| 本文 | 15px | 1.65 | 263px | 12px |
| 補助 | 14px | — | — | — |
| 注記 | 13px | — | — | — |
...
| 3 | 1460px | — | 6カラム・画像あり | 中央 | 見出しの下 |
| 4 | 680px | — | 2カラム・画像あり | 中央 | 見出しの下 |
| 5 | 920px | — | 2カラム・画像あり | 中央 | 見出しの下 |
| 6 | 780px | `#ff0000` | 2カラム・画像あり | 中央 | 見出しの下 |
...
角丸は 0px だが、**完全な円は別扱い**で 22 箇所ある（40px×11、72px×10、24px×1）。
アイコンの地・点・装飾に使う。角を丸めないルールと、円のモチーフは両立する。

## 画像

- 81枚使っている
- 比率は 1:1（47枚）、21:9（21枚）、3:2（2枚）
- 角丸 0px。切り抜かず四角のまま置く
