...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 36px | 1.45 | 10px | 10px |
| 見出し | 32px | 1.6 | 2px | 302px |
| 小見出し | 22px | 1.4 | 147px | 10px |
| リード | 20px | 1.6 | 96px | 37px |
| 本文 | 15px | 2 | — | — |
| 補助 | 14px | 1.6 | 4px | 61px |
| 注記 | 13px | — | — | — |
...
```css
.c-head__label{ font-size:22px; font-weight:700; letter-spacing:0.05em;
  color:#e13009; text-transform:uppercase }
.c-head__title{ font-size:40px; margin-top:10px }
.c-head + *{ margin-top:117px }
```

- ラベルと見出しの間は 10px、見出しと本文の間は 117px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:22px; font-weight:700; letter-spacing:0.05em; color:#e13009 }
.c-head__title{ font-size:40px; margin-top:10px }
.c-head + *{ margin-top:117px }
