...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 48px | 1 | 30px | 23px |
| 見出し | 34px | 1.5 | 232px | 0px |
| 小見出し | 18px | 1.4 | 2px | 13px |
| リード | 16px | 1.4 | 53px | 58px |
| 本文 | 14px | 2 | — | — |
| 補助 | 13px | 1 | — | 258px |
| 注記 | 12px | — | — | — |
...
```css
.c-head__label{ font-size:13px; font-weight:700; letter-spacing:0.024em;
  color:#f26d3f; text-transform:uppercase }
.c-head__title{ font-size:28px; margin-top:14px }
.c-head__title + *{ margin-top:263px }
```

- ラベルと見出しの間は 14px、見出しと本文の間は 263px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:13px; font-weight:700; letter-spacing:0.024em; color:#f26d3f }
.c-head__title{ font-size:28px; margin-top:14px }
.c-head__title + *{ margin-top:263px }
