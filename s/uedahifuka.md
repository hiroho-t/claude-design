...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 25px | 1 | 120px | 59px |
| 見出し | 20px | 1 | 95px | 38px |
| 小見出し | 16px | — | 145px | 24px |
| リード | 15px | 1.8 | 1px | 72px |
| 本文 | 14px | 1 | — | — |
| 補助 | 13px | — | 238px | 15px |
| 注記 | 12px | — | 45px | — |
...
| 見出し | 25px | 14px / 行間 1.65 |
| セクションの上下余白 | 40px | 60px |
| 左右の余白 | — | 0px |
| 並びの間隔 | 27px | 6px |

- 本文は 14px → 13px、セクション余白は 40px → 60px（PCの150%）。
...
@media (max-width:768px){
  :root{ --fs-body:13px; --section-y:60px; --gap:6px; }
