...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 80px | 1.1 | 293px | 81px |
| 見出し | 45px | 1.3 | 45px | 18px |
| 小見出し | 36px | — | — | — |
| リード | 25px | — | — | — |
| 本文 | 16px | 1.4 | — | — |
| 補助 | 15px | — | — | — |
...
```css
.c-head__label{ font-size:14px; font-weight:500; letter-spacing:-0.01em;
  color:#231815; text-transform:uppercase }
.c-head__title{ font-size:45px; line-height:1.3; margin-top:45px }
.c-head + *{ margin-top:18px }
```

- ラベルと見出しの間は 45px、見出しと本文の間は 18px。この2つを同じにしない。
...
.c-head__label{ font-size:14px; font-weight:500; letter-spacing:-0.01em; color:#231815 }
.c-head__title{ font-size:45px; line-height:1.3; margin-top:45px }
.c-head + *{ margin-top:18px }
