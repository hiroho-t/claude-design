...
- `#011c29` は面として10箇所、文字として7箇所。塗りが主役。ボタンの地にも使う。枠線にも1箇所。
...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 32px | 1.4 | 281px | 199px |
| 見出し | 24px | 1.5 | 100px | 15px |
| 小見出し | 20px | 1.5 | 349px | 241px |
| リード | 16px | 1.8 | 268px | 22px |
| 本文 | 12px | 2 | — | — |
