...
白地に `#fe1f54` を文字と細部だけで効かせる配色。影を使って浮かせる。本文 15px・行間 1.6、セクション間 40px。
...
文字色は `#454545` / `#7e8c8d` / `#fe1f54` / `#ffffff`。
...
|---|---|---|---|---|
| 大見出し | 68px | 1.6 | — | 105px |
| 見出し | 34px | 1 | 341px | 96px |
| 小見出し | 28px | 1.6 | 387px | 383px |
| リード | 20px | — | — | — |
| 本文 | 15px | 1.6 | — | — |
| 補助 | 14px | — | — | — |
| 注記 | 13px | — | — | — |
...
| | PC 1440px | スマホ 390px |
|---|---|---|
| 本文 | 15px / 行間 1.6 | 16px / 行間 1.8 |
| 見出し | 68px | 35px / 行間 1.3 |
| セクションの上下余白 | 40px | 32px |
| 左右の余白 | — | 21px |
| 並びの間隔 | 15px | 10px |

- 本文は 15px → 16px、セクション余白は 40px → 32px（PCの80%）。
