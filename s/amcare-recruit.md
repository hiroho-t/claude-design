...
白地に `#243149` を文字と細部だけで効かせる配色。影も枠線もほとんど使わない。本文 20px・行間 1.8、セクション間 140px。
...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 56px | 1.6 | 188px | 56px |
| 見出し | 46px | 1.6 | 227px | 56px |
| 小見出し | 45px | 1.6 | 133px | 336px |
| リード | 22px | 1.8 | 64px | 306px |
| 本文 | 20px | 1.8 | 16px | 243px |
| 補助 | 18px | — | — | — |
| 注記 | 16px | — | — | — |
...
| | PC 1440px | スマホ 390px |
|---|---|---|
| 本文 | 20px / 行間 1.8 | 14px / 行間 1.6 |
| 見出し | 56px | 24px / 行間 1.6 |
| セクションの上下余白 | 140px | 56px |
| 左右の余白 | — | 20px |
| 並びの間隔 | 16px | 12px |

- 本文は 20px → 14px、セクション余白は 140px → 56px（PCの40%）。
