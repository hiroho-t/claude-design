...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 19px | 1.7 | 121px | 150px |
| 見出し | 16px | — | 5px | 8px |
| 小見出し | 15px | 1.45 | 298px | 8px |
| リード | 14px | 1.45 | 6px | 10px |
| 本文 | 12px | 1.42 | — | — |
| 補助 | 11px | 1.36 | 85px | — |
...
| 見出し | 19px | 12px / 行間 1.4 |
| セクションの上下余白 | 40px | 24px |
| 左右の余白 | — | 0px |
| 並びの間隔 | 10px | 10px |

- 本文は 12px → 13px、セクション余白は 40px → 24px（PCの60%）。
...
|---|---|---|---|---|---|
| 1 | 760px | — | ヒーロー（画像） | — | 全幅 |
| 2 | 340px | — | 1カラム・画像あり | — | 全面 |
| 3 | 340px | — | 1カラム・画像あり | — | 全面 |
| 4 | 340px | — | 1カラム・画像あり | — | 全面 |
| 5 | 340px | — | 1カラム・画像あり | — | 全面 |
| 6 | 340px | — | 3カラム・画像あり | 中央 | — |
| 7 | 360px | — | 6カラム・画像あり | 中央 | 見出しの下 |
| 8 | 200px | — | 帯・区切り | — | 全面 |
| 9 | 660px | — | 5カラム・画像あり | 中央 | 見出しの下 |
| 10 | 880px | — | 6カラム・画像あり | 左 | 見出しの下 |
| 11 | 680px | — | 1カラム・画像あり | 中央 | 見出しの下 |
| 12 | 440px | — | 4カラム・画像あり | 中央 | 見出しの下 |
| 13 | 700px | — | 6カラム・画像あり | 右 | 左（50:50） |

- 全13セクション、すべて全幅。中央に寄せた箱を積むのではなく、色面を全幅で切り替えながら進む。
- 使われている面の色: `#ffffff`（14） / `#fcfbf5`（2） / `#faf7e8`（2） / `#cccabd`（1）
- 見出しは左1／中央5。
...
@media (max-width:768px){
  :root{ --fs-body:13px; --section-y:24px; --gap:10px; }
