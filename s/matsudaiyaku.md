...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 36px | 1.3 | 4px | 122px |
| 見出し | 32px | 1.3 | 140px | 63px |
| 小見出し | 24px | 1.3 | 210px | 40px |
| リード | 21px | — | — | — |
| 本文 | 16px | 1.6 | — | 7px |
| 補助 | 13px | — | — | — |
...
```css
.c-head__label{ font-size:16px; font-weight:500; letter-spacing:0.037em;
  color:#141414 }
.c-head__title{ font-size:36px; line-height:1.3; margin-top:4px }
.c-head + *{ margin-top:122px }
```

- ラベルと見出しの間は 4px、見出しと本文の間は 122px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:16px; font-weight:500; letter-spacing:0.037em; color:#141414 }
.c-head__title{ font-size:36px; line-height:1.3; margin-top:4px }
.c-head + *{ margin-top:122px }
