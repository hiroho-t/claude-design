...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 29px | 1.08 | 11px | 101px |
| 見出し | 23px | 1.35 | 77px | 70px |
| 小見出し | 22px | 1.5 | 18px | 9px |
| リード | 16px | — | — | 14px |
| 本文 | 14px | 1.5 | 225px | 4px |
| 補助 | 12px | — | — | — |
| 注記 | 11px | — | — | — |
...
小さいラベルを見出しの上に置く型を 5箇所で使っている（見出し7箇所のうち）。
...
```css
.c-head__label{ font-size:14px; font-weight:500; letter-spacing:0.05em;
  color:#719c8b }
.c-head__title{ font-size:29px; line-height:1.08; margin-top:11px }
.c-head + *{ margin-top:101px }
```

- ラベルと見出しの間は 11px、見出しと本文の間は 101px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:14px; font-weight:500; letter-spacing:0.05em; color:#719c8b }
.c-head__title{ font-size:29px; line-height:1.08; margin-top:11px }
.c-head + *{ margin-top:101px }
