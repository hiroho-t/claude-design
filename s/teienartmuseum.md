...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 42px | 1.08 | 75px | 61px |
| 見出し | 22px | 1.5 | 12px | 25px |
| 小見出し | 19px | — | — | — |
| リード | 18px | 1.5 | 10px | 9px |
| 本文 | 11px | 1.5 | — | — |
...
@media (max-width:768px){
  :root{ --fs-body:10px; --section-y:32px; --gap:6px; }
