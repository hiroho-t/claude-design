...
| | PC 1440px | スマホ 390px |
|---|---|---|
| 本文 | 16px / 行間 1.87 | 17px / 行間 1.88 |
| 見出し | 28px | 21px / 行間 1.7 |
| セクションの上下余白 | 84px | 32px |
| 左右の余白 | — | 21px |
| 並びの間隔 | 16px | —px |

- 本文は 16px → 17px、セクション余白は 84px → 32px（PCの38%）。
- 文字サイズの段は 19 / 17 / 16 / 15 / 11px。
