...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 34px | 1.5 | 12px | 45px |
| 見出し | 32px | 1.6 | 15px | 30px |
| 小見出し | 22px | 1.5 | 60px | 60px |
| リード | 18px | 1.5 | 305px | 12px |
| 本文 | 15px | 2 | 8px | 69px |
| 補助 | 14px | — | 9px | 262px |
| 注記 | 13px | — | — | — |
...
```css
.c-head__label{ font-size:16px; font-weight:500;
  color:#1eb8d4; text-transform:uppercase }
.c-head__title{ font-size:32px; line-height:1.6; margin-top:12px }
.c-head__title + *{ margin-top:30px }
```

- ラベルと見出しの間は 12px、見出しと本文の間は 30px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:16px; font-weight:500; color:#1eb8d4 }
.c-head__title{ font-size:32px; line-height:1.6; margin-top:12px }
.c-head__title + *{ margin-top:30px }
