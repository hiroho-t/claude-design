...
|---|---|---|---|---|
| 大見出し | 25px | — | — | — |
| 見出し | 20px | 1.5 | 14px | 195px |
| 小見出し | 18px | — | — | — |
| 本文 | 16px | 1.75 | 65px | 65px |
| 補助 | 15px | — | — | — |
| 注記 | 13px | — | — | — |
...
```css
.c-head__label{ font-size:10px; font-weight:500;
  color:#ffffff }
.c-head__title{ font-size:20px; line-height:1.5; margin-top:14px }
.c-head + *{ margin-top:195px }
```

- ラベルと見出しの間は 14px、見出しと本文の間は 195px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:10px; font-weight:500; color:#ffffff }
.c-head__title{ font-size:20px; line-height:1.5; margin-top:14px }
.c-head + *{ margin-top:195px }
