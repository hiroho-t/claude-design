...
| 大見出し | 336px | 1 | — | 56px |
| 本文 | 41px | 1.5 | — | — |
| 補助 | 38px | 1.5 | 312px | 76px |
| 注記 | 31px | 1.55 | 36px | 24px |
...
|---|---|---|
| 本文 | 41px / 行間 1.5 | 14px |
| 見出し | 336px | 19px / 行間 1.5 |
| セクションの上下余白 | 72px | 32px |
| 左右の余白 | — | 19px |
| 並びの間隔 | 24px | 8px |

- 本文は 41px → 14px、セクション余白は 72px → 32px（PCの44%）。
- 文字サイズの段は 32 / 18 / 16 / 15 / 14px。
...
| # | 高さ | 地色 | 中身 | 見出し | 画像 |
|---|---|---|---|---|---|
| 1 | 1680px | — | ヒーロー（画像） | 左 | 見出しの下 |
| 2 | 920px | — | 5カラム・画像あり | 左 | 見出しの下 |
...
- 使われている面の色: `#f5f5f5`（9） / `#383838`（4） / `#ffffff`（3） / `#888888`（1）
- 見出しは左4／中央2。
...
.hero{ min-height:1680px; display:grid; align-content:center }
