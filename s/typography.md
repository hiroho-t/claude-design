...
|---|---|---|---|---|
| 大見出し | 44px | — | — | — |
| 見出し | 22px | — | 239px | 154px |
| 小見出し | 16px | 1.4 | 283px | 16px |
| リード | 14px | — | — | — |
| 本文 | 11px | 1 | — | 16px |
...
- コンテンツ幅: 最大 1276px／読ませる段は 1260px
...
| | PC 1440px | スマホ 390px |
|---|---|---|
| 本文 | 11px / 行間 1 | 10px / 行間 1.45 |
| 見出し | 44px | 20px |
| セクションの上下余白 | 76px | 76px |
| 左右の余白 | — | 20px |
| 並びの間隔 | 9px | 9px |

- 本文は 11px → 10px、セクション余白は 76px → 76px（PCの100%）。
...
@media (max-width:640px){
  :root{ --fs-body:10px; --section-y:76px; --gap:9px; }
