...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 60px | 1.35 | 199px | 24px |
| 見出し | 40px | 1.3 | 21px | 64px |
| 小見出し | 21px | 1.5 | 300px | 16px |
| リード | 17px | — | — | — |
| 本文 | 16px | 2 | — | — |
| 補助 | 15px | — | — | — |
| 注記 | 14px | — | — | — |
...
- 上の余白は、セクションの先頭に来る見出しだとセクションの上下余白（84px）を含む。まとまりの中の間隔は「見出しのまとまり」を見る。
...
```css
.c-head__label{ font-size:20px; font-weight:400; letter-spacing:0.1em;
  color:#ffffff; text-transform:uppercase }
.c-head__title{ font-size:40px; line-height:1.3; margin-top:21px }
.c-head__title + *{ margin-top:64px }
```

- ラベルと見出しの間は 21px、見出しと本文の間は 64px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:20px; font-weight:400; letter-spacing:0.1em; color:#ffffff }
.c-head__title{ font-size:40px; line-height:1.3; margin-top:21px }
.c-head__title + *{ margin-top:64px }
