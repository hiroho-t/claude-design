...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 37px | 1.5 | 272px | 9px |
| 見出し | 19px | 1.5 | 37px | 184px |
| 小見出し | 18px | — | 8px | 9px |
| リード | 17px | — | 318px | 217px |
| 本文 | 16px | 1.5 | 16px | 225px |
| 補助 | 14px | — | — | — |
| 注記 | 12px | — | — | — |
...
| 4 | 1380px | `#d80012` | 5カラム・画像あり | 中央 | 見出しの下 |
| 5 | 1600px | `#ffffff` | 6カラム・画像あり | 中央 | 見出しの下 |
| 6 | 3040px | `#fff7eb` | 6カラム・画像あり | 中央 | 見出しの下 |
