...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 40px | 1.55 | 10px | 54px |
| 見出し | 18px | — | — | — |
| 小見出し | 17px | 1.55 | 18px | 325px |
| 本文 | 16px | 1.9 | — | — |
| 補助 | 14px | 1.55 | 10px | 81px |
| 注記 | 13px | — | — | — |
...
小さいラベルを見出しの上に置く型を 6箇所で使っている（見出し8箇所のうち）。
...
```css
.c-head__label{ font-size:10px; font-weight:400; letter-spacing:0.128em;
  color:#6b6b6b }
.c-head__title{ font-size:17px; line-height:1.55; margin-top:18px }
.c-head__title + *{ margin-top:325px }
```

- ラベルと見出しの間は 18px、見出しと本文の間は 325px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:10px; font-weight:400; letter-spacing:0.128em; color:#6b6b6b }
.c-head__title{ font-size:17px; line-height:1.55; margin-top:18px }
.c-head__title + *{ margin-top:325px }
