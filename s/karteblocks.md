...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 48px | 1.6 | 8px | 40px |
| 見出し | 36px | 1.4 | 4px | 13px |
| 小見出し | 32px | 1.5 | 0px | 8px |
| リード | 24px | — | 175px | 16px |
| 本文 | 16px | 2 | — | — |
| 補助 | 14px | — | — | — |
| 注記 | 12px | — | — | — |
...
```css
.c-head__label{ font-size:20px; font-weight:700; letter-spacing:0.02em;
  color:#00100e; text-transform:uppercase }
.c-head__title{ font-size:48px; line-height:1.6; margin-top:8px }
.c-head__title + *{ margin-top:40px }
```

- ラベルと見出しの間は 8px、見出しと本文の間は 40px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:20px; font-weight:700; letter-spacing:0.02em; color:#00100e }
.c-head__title{ font-size:48px; line-height:1.6; margin-top:8px }
.c-head__title + *{ margin-top:40px }
