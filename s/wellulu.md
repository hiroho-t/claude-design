...
- `#e7cc6c` は面として31箇所、文字として0箇所。塗りが主役。ボタンの地には使っていない。
...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 33px | 1.2 | 114px | 30px |
| 見出し | 22px | 1.5 | 11px | 24px |
| 本文 | 18px | 1.5 | 9px | 20px |
| 補助 | 16px | 1.6 | 281px | 35px |
| 注記 | 15px | — | — | — |
