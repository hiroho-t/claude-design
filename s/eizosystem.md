...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 48px | 1.35 | 253px | 15px |
| 見出し | 22px | 1.4 | 291px | 93px |
| 小見出し | 18px | 1.1 | 47px | 135px |
| リード | 16px | 1.4 | 297px | 107px |
| 本文 | 15px | 1.7 | — | — |
| 補助 | 14px | — | 64px | 47px |
| 注記 | 13px | 1 | 135px | 14px |
...
@media (max-width:768px){
  :root{ --fs-body:15px; --section-y:68px; --gap:21px; }
