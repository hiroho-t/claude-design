...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 20px | 1.5 | 100px | 8px |
| 見出し | 16px | 1.5 | 8px | 8px |
| 小見出し | 15px | — | — | — |
| リード | 14px | — | — | — |
| 本文 | 12px | 1.5 | — | — |
...
.c-head__label{ font-size:12px; font-weight:700;
  color:#666666 }
.c-head__title{ font-size:20px; line-height:1.5; margin-top:12px }
.c-head__title + *{ margin-top:8px }
```

- ラベルと見出しの間は 12px、見出しと本文の間は 8px。この2つを同じにしない。
...
.c-head__label{ font-size:12px; font-weight:700; color:#666666 }
.c-head__title{ font-size:20px; line-height:1.5; margin-top:12px }
.c-head__title + *{ margin-top:8px }
