...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 48px | 1.25 | 224px | 40px |
| 見出し | 44px | 1.25 | 23px | 30px |
| 小見出し | 24px | — | — | — |
| リード | 22px | — | — | — |
| 本文 | 14px | 1.75 | — | — |
| 補助 | 12px | — | — | — |
...
小さいラベルを見出しの上に置く型を 2箇所で使っている（見出し5箇所のうち）。
...
```css
.c-head__label{ font-size:14px; font-weight:500; letter-spacing:0.04em;
  color:#ffffff; text-transform:uppercase }
.c-head__title{ font-size:44px; line-height:1.25; margin-top:23px }
.c-head__title + *{ margin-top:30px }
```

- ラベルと見出しの間は 23px、見出しと本文の間は 30px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:14px; font-weight:500; letter-spacing:0.04em; color:#ffffff }
.c-head__title{ font-size:44px; line-height:1.25; margin-top:23px }
.c-head__title + *{ margin-top:30px }
