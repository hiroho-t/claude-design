...
文字色は `#614a3f` / `#f2f2f2` / `#317559` / `#ffffff`。
...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 40px | 1 | 108px | 43px |
| 見出し | 26px | 1.5 | 94px | 15px |
| 小見出し | 22px | — | — | — |
| 本文 | 16px | 1.8 | 66px | 104px |
| 補助 | 15px | — | — | — |
| 注記 | 14px | — | — | — |
...
| 1 | 7040px | — | ヒーロー | — | — |
| 2 | 900px | — | 1カラム・画像あり | 右 | — |
| 3 | 7040px | — | 6カラム・画像あり | 左 | 全幅 |

- 全3セクション。
- 使われている面の色: `#fdfbfa`（10） / `#ffffff`（4） / `#f1dec1`（1）
...
角丸は 0px だが、**完全な円は別扱い**で 5 箇所ある（80px×5）。
アイコンの地・点・装飾に使う。角を丸めないルールと、円のモチーフは両立する。

## 画像

- 42枚使っている。うち 1 枚は画面いっぱいに置く
- 比率は 21:9（16枚）、1:1（11枚）、4:3（9枚）
- 角丸 0px。切り抜かず四角のまま置く
...
.hero{ min-height:7040px; display:grid; align-content:center }
