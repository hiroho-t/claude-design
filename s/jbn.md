...
- `#111111` は文字色として144箇所で使うのが主。面としては4箇所しかないが、1枚が大きく画面の22%を占める。ボタンの地にも使う。枠線にも9箇所。
...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 40px | 1.4 | 220px | 51px |
| 見出し | 36px | 1.5 | 281px | 36px |
| 小見出し | 34px | 1.4 | 320px | 36px |
| 本文 | 18px | 1.4 | — | — |
| 補助 | 16px | — | — | — |
| 注記 | 15px | — | — | — |
