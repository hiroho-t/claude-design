...
|---|---|---|---|---|
| 大見出し | 28px | — | — | 133px |
| 見出し | 18px | 1.78 | 85px | 71px |
| 小見出し | 15px | 1 | 20px | 45px |
| リード | 14px | — | — | — |
| 本文 | 13px | 1.92 | — | — |
| 補助 | 12px | — | — | — |
| 注記 | 10px | 1 | 147px | 36px |
...
- 14枚使っている。うち 2 枚は画面いっぱいに置く
- 比率は 1:1（6枚）、4:3（3枚）、16:9（1枚）
- 角丸 0px。切り抜かず四角のまま置く
