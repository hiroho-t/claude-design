...
#f7f7f7 の地に `#f7f7f7` を大きな面で置く配色。影を使って浮かせる。本文 15px・行間 1.7、セクション間 100px。
...
- 主色 `#f7f7f7` は差し色ではなく**面**で使う。画面の86%を占めている。
...
- `#f7f7f7` は面として12箇所、文字として0箇所。塗りが主役。ボタンの地には使っていない。
...
- 主色 `#f7f7f7` の面が 6 箇所。地色と主色の面を交互に置くのがリズムのつくり方。
...
- 地色と主色 `#f7f7f7` の面を全幅で交互に置く。主色は画面の86%を占めるだけ使う。
