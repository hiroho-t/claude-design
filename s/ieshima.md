...
- 和文: Satoshi
- 欧文: Satoshi
- ウェイトは 500 / 400 / 600 が中心。太さで強弱をつけず、大きさで差をつける。

| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 80px | 1.4 | 233px | 191px |
| 見出し | 28px | 1.6 | 6px | — |
| 小見出し | 20px | — | 254px | 187px |
| 本文 | 18px | 1.7 | 66px | 65px |
| 補助 | 16px | 1.8 | 21px | 101px |
| 注記 | 15px | 1.6 | 29px | 6px |
