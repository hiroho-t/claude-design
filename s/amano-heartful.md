...
- `#009644` は文字色として6箇所で使うのが主。面としては0箇所しかないが、1枚が大きく画面の0%を占める。ボタンの地には使っていない。
...
| 見出し | 46px | 1.88 | — | 15px |
| 小見出し | 40px | 1.3 | — | 301px |
| リード | 28px | 1.67 | 248px | 136px |
| 本文 | 15px | 1.67 | 246px | 12px |
| 補助 | 14px | — | 15px | 15px |
| 注記 | 13px | — | — | — |
...
| 2 | 200px | — | 帯・区切り | 左 | 右（35:65） |
| 3 | 3660px | — | 5カラム・画像あり | 左 | 見出しの下 |
| 4 | 400px | — | 6カラム・画像あり | 左 | 左（39:61） |
...
- 使われている面の色: 
- 見出しは左5／中央1。
- 2カラムの分け方は 73:27 / 35:65 / 39:61 / 87:13。半分ずつには割らない。
