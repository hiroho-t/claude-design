...
文字色は `#555555` / `#d5d5d5` / `#ffffff` / `#c1c1c1`。
...
|---|---|---|---|---|
| 大見出し | 40px | 1.27 | — | — |
| 見出し | 20px | 1.25 | 164px | 10px |
| 小見出し | 18px | 1.67 | 120px | 36px |
| リード | 15px | — | — | — |
| 本文 | 14px | 1.87 | 33px | 33px |
| 補助 | 13px | — | — | — |
| 注記 | 12px | — | — | — |
...
.btn-sub{
  background: transparent; color: #555555;
  border: 1px;
  border-radius: 0px; padding: 15px 20px; min-height: 80px;
