...
- `#f72a48` は文字色として28箇所で使うのが主。面としては0箇所しかないが、1枚が大きく画面の0%を占める。ボタンの地には使っていない。
...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 40px | 1.4 | 258px | 80px |
| 見出し | 32px | 1.4 | 26px | 43px |
| 小見出し | 24px | 1.4 | 138px | 40px |
| リード | 16px | 1.75 | 87px | 46px |
| 本文 | 14px | 1.4 | 239px | 161px |
| 補助 | 13px | — | 54px | 80px |
| 注記 | 12px | — | — | — |
