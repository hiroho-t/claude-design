...
白地に `#d8eeff` を大きな面で置く配色。影も枠線もほとんど使わない。本文 14px・行間 1.5、セクション間 100px。
...
|---|---|---|---|---|
| 大見出し | 68px | — | — | — |
| 見出し | 64px | 1.2 | 324px | 335px |
| 小見出し | 40px | 1.2 | 231px | 102px |
| リード | 16px | 1.5 | 379px | 21px |
| 本文 | 14px | 1.5 | — | — |
| 補助 | 12px | — | — | — |
| 注記 | 11px | — | — | — |
...
| | PC 1440px | スマホ 390px |
|---|---|---|
| 本文 | 14px / 行間 1.5 | 15px / 行間 1.75 |
| セクションの上下余白 | 100px | 28px |
| 左右の余白 | — | 26px |
| 並びの間隔 | 22px | 25px |

- 本文は 14px → 15px、セクション余白は 100px → 28px（PCの28%）。
