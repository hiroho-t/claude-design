...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 40px | 1.3 | 26px | 69px |
| 見出し | 30px | 1.2 | 36px | 16px |
| 小見出し | 18px | 1.4 | 182px | 12px |
| リード | 17px | — | 75px | 12px |
| 本文 | 16px | 1 | 85px | 85px |
| 補助 | 15px | — | — | — |
| 注記 | 14px | — | — | — |
...
小さいラベルを見出しの上に置く型を 7箇所で使っている（見出し18箇所のうち）。
...
```css
.c-head__label{ font-size:16px; font-weight:600; letter-spacing:-0.02em;
  color:#222222; text-transform:uppercase }
.c-head__title{ font-size:40px; line-height:1.3; margin-top:26px }
.c-head + *{ margin-top:69px }
```

- ラベルと見出しの間は 26px、見出しと本文の間は 69px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:16px; font-weight:600; letter-spacing:-0.02em; color:#222222 }
.c-head__title{ font-size:40px; line-height:1.3; margin-top:26px }
.c-head + *{ margin-top:69px }
