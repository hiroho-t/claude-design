...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 20px | 1.7 | 20px | 35px |
| 見出し | 18px | 1.6 | 9px | 14px |
| 小見出し | 16px | 1.8 | 48px | 48px |
| 本文 | 14px | 2.02 | — | — |
| 補助 | 13px | — | — | — |
| 注記 | 12px | — | — | — |
...
```css
.c-head__label{ font-size:12px; font-weight:500; letter-spacing:0.066em;
  color:#ffffff }
.c-head__title{ font-size:20px; line-height:1.7; margin-top:20px }
.c-head + *{ margin-top:35px }
```

- ラベルと見出しの間は 20px、見出しと本文の間は 35px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:12px; font-weight:500; letter-spacing:0.066em; color:#ffffff }
.c-head__title{ font-size:20px; line-height:1.7; margin-top:20px }
.c-head + *{ margin-top:35px }
