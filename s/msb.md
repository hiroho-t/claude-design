...
- `#e60012` は文字色として92箇所で使うのが主。面としては12箇所しかないが、1枚が大きく画面の0%を占める。ボタンの地には使っていない。枠線にも39箇所。
...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 48px | 1.33 | 187px | 31px |
| 見出し | 32px | 1.25 | 24px | 64px |
| 小見出し | 24px | 1.25 | 34px | 149px |
| リード | 20px | — | — | — |
| 本文 | 15px | 1.87 | — | — |
| 補助 | 14px | — | — | — |
| 注記 | 10px | 1 | — | 187px |
...
- 上の余白は、セクションの先頭に来る見出しだとセクションの上下余白（136px）を含む。まとまりの中の間隔は「見出しのまとまり」を見る。

- 本文は 15px・行間 1.87。

## 見出しのまとまり

小さいラベルを見出しの上に置く型を 10箇所で使っている（見出し12箇所のうち）。
...
```css
.c-head__label{ font-size:14px; font-weight:700; letter-spacing:0.05em;
  color:#e60012; text-transform:uppercase }
.c-head__title{ font-size:32px; line-height:1.25; margin-top:24px }
...
.c-head__label{ font-size:14px; font-weight:700; letter-spacing:0.05em; color:#e60012 }
.c-head__title{ font-size:32px; line-height:1.25; margin-top:24px }
.c-head + *{ margin-top:64px }
