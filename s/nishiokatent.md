...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 40px | 1.4 | 12px | 46px |
| 見出し | 24px | — | 110px | 324px |
| 小見出し | 22px | 1.2 | 324px | 186px |
| リード | 18px | — | — | — |
| 本文 | 16px | — | — | — |
| 補助 | 15px | — | — | — |
...
```css
.c-head__label{ font-size:15px; font-weight:700; letter-spacing:0.08em;
  color:#1955a6; text-transform:uppercase }
.c-head__title{ font-size:40px; line-height:1.4; margin-top:12px }
.c-head + *{ margin-top:46px }
```

- ラベルと見出しの間は 12px、見出しと本文の間は 46px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:15px; font-weight:700; letter-spacing:0.08em; color:#1955a6 }
.c-head__title{ font-size:40px; line-height:1.4; margin-top:12px }
.c-head + *{ margin-top:46px }
