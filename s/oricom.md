...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 64px | 1.2 | 8px | 92px |
| 見出し | 24px | 1.5 | 16px | 68px |
| 小見出し | 20px | — | 334px | 28px |
| リード | 18px | 1.75 | 237px | 8px |
| 本文 | 16px | 2 | 20px | 16px |
| 補助 | 14px | — | — | — |
| 注記 | 13px | — | — | — |
...
小さいラベルを見出しの上に置く型を 11箇所で使っている（見出し16箇所のうち）。
...
```css
.c-head__label{ font-size:14px; font-weight:400;
  color:#000000; text-transform:uppercase }
.c-head__title{ font-size:24px; line-height:1.5; margin-top:16px }
.c-head + *{ margin-top:68px }
```

- ラベルと見出しの間は 16px、見出しと本文の間は 68px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:14px; font-weight:400; color:#000000 }
.c-head__title{ font-size:24px; line-height:1.5; margin-top:16px }
.c-head + *{ margin-top:68px }
