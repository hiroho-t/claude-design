...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 42px | 1.42 | 200px | 10px |
| 見出し | 38px | 1.4 | 385px | 145px |
| 小見出し | 30px | 1.6 | 10px | 25px |
| リード | 18px | — | — | — |
| 本文 | 14px | 2.14 | — | — |
| 補助 | 12px | — | — | — |
...
```css
.c-head__label{ font-size:18px; font-weight:400; letter-spacing:0.05em;
  color:#b30001; text-transform:uppercase }
.c-head__title{ font-size:30px; line-height:1.6; margin-top:10px }
.c-head + *{ margin-top:25px }
```

- ラベルと見出しの間は 10px、見出しと本文の間は 25px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:18px; font-weight:400; letter-spacing:0.05em; color:#b30001 }
.c-head__title{ font-size:30px; line-height:1.6; margin-top:10px }
.c-head + *{ margin-top:25px }
