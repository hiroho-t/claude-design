...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 32px | 1.6 | 186px | 76px |
| 見出し | 28px | 1.61 | 166px | 88px |
| 小見出し | 20px | 1.6 | 61px | 74px |
| リード | 18px | — | 221px | 27px |
| 本文 | 14px | 1.6 | — | — |
| 補助 | 12px | — | — | — |
...
- コンテンツ幅: 最大 1280px／読ませる段は 1380px
...
| 12 | 480px | — | 1カラム・画像あり | — | 全幅 |
| 13 | 480px | — | 1カラム・画像あり | — | 全幅 |
