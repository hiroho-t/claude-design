...
- 欧文: YakuHanMP
- ウェイトは 300 / 400 / 500 が中心。太さで強弱をつけず、大きさで差をつける。

| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 40px | 1.8 | 0px | 80px |
| 見出し | 36px | 1 | 0px | 377px |
| 小見出し | 20px | — | — | — |
| リード | 17px | 1.6 | 157px | 136px |
| 本文 | 16px | 2.2 | — | — |
| 補助 | 14px | — | — | — |
| 注記 | 13px | — | — | — |
...
```css
.c-head__label{ font-size:13px; font-weight:300;
  color:#a7917b; text-transform:uppercase }
.c-head__title{ font-size:36px; line-height:1; margin-top:0px }
.c-head + *{ margin-top:377px }
```

- ラベルと見出しの間は 0px、見出しと本文の間は 377px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:13px; font-weight:300; color:#a7917b }
.c-head__title{ font-size:36px; line-height:1; margin-top:0px }
.c-head + *{ margin-top:377px }
