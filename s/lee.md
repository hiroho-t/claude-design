...
文字色は `#000000` / `#555555` / `#333333` / `#ffffff`。
...
- 実測した囲みの線は ``。ただしその囲みは `#ba0450` の面の上にしか無かった。**別の面に置くときは、その面の反対色にする。**
...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 48px | 1.6 | 94px | 90px |
| 見出し | 28px | 1.6 | 63px | 223px |
| 小見出し | 18px | — | — | — |
| リード | 16px | — | — | — |
| 本文 | 14px | 1.6 | — | — |
| 補助 | 12px | — | — | — |
...
| 7 | 1400px | `#ba0450` | 6カラム・画像あり | 左 | 見出しの下 |

- 全7セクション。
- 使われている面の色: `#ffffff`（13） / `#ba0450`（3） / `#f5f5f5`（1） / `#333333`（1）
- 見出しは左4／中央1。
