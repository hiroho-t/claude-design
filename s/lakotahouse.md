...
|---|---|---|---|---|
| 大見出し | 56px | 1 | 0px | 0px |
| 見出し | 36px | 1 | 10px | 12px |
| 小見出し | 20px | 1.63 | 215px | 38px |
| リード | 16px | — | — | — |
| 本文 | 15px | 1.6 | — | — |
| 補助 | 13px | — | — | — |
...
小さいラベルを見出しの上に置く型を 4箇所で使っている（見出し9箇所のうち）。
...
```css
.c-head__label{ font-size:20px; font-weight:500;
  color:#ffffff; text-transform:uppercase }
.c-head__title{ font-size:36px; line-height:1; margin-top:10px }
.c-head__title + *{ margin-top:12px }
```

- ラベルと見出しの間は 10px、見出しと本文の間は 12px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
- 65枚使っている。うち 22 枚は画面いっぱいに置く
- 比率は 3:4（35枚）、3:2（25枚）、1:1（5枚）
- 角丸 0px。切り抜かず四角のまま置く
...
.c-head__label{ font-size:20px; font-weight:500; color:#ffffff }
.c-head__title{ font-size:36px; line-height:1; margin-top:10px }
.c-head__title + *{ margin-top:12px }
