...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 41px | 1.5 | 84px | 30px |
| 見出し | 32px | 1.5 | 10px | 104px |
| 小見出し | 24px | — | — | — |
| 本文 | 16px | 1.75 | — | — |
| 補助 | 14px | 1.75 | — | — |
| 注記 | 12px | — | — | — |
...
```css
.c-head__label{ font-size:16px; font-weight:700; letter-spacing:0.03em;
  color:#da3734; text-transform:uppercase }
.c-head__title{ font-size:32px; line-height:1.5; margin-top:10px }
.c-head + *{ margin-top:104px }
```

- ラベルと見出しの間は 10px、見出しと本文の間は 104px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:16px; font-weight:700; letter-spacing:0.03em; color:#da3734 }
.c-head__title{ font-size:32px; line-height:1.5; margin-top:10px }
.c-head + *{ margin-top:104px }
