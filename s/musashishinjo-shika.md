...
```css
.c-head__label{ font-size:13px; font-weight:700; letter-spacing:0.12em;
  color:#03b2eb; text-transform:uppercase }
.c-head__title{ font-size:25px; margin-top:0px }
.c-head + *{ margin-top:171px }
```

- ラベルと見出しの間は 0px、見出しと本文の間は 171px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:13px; font-weight:700; letter-spacing:0.12em; color:#03b2eb }
.c-head__title{ font-size:25px; margin-top:0px }
.c-head + *{ margin-top:171px }
