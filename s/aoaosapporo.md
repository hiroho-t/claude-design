...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 48px | 1 | 145px | 0px |
| 見出し | 24px | 1.5 | 24px | 24px |
| 本文 | 16px | 1 | 16px | 21px |
| 補助 | 14px | — | — | — |
| 注記 | 12px | — | — | — |
...
- 65枚使っている。うち 6 枚は画面いっぱいに置く
- 比率は 4:3（38枚）、1:1（10枚）、3:2（9枚）
- 角丸 5px。画像も箱と同じだけ丸める
...
@media (max-width:768px){
  :root{ --fs-body:16px; --section-y:60px; --gap:30px; }
