...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 50px | 1 | 314px | 239px |
| 見出し | 30px | 1 | 14px | 282px |
| 小見出し | 20px | 1 | 15px | — |
| リード | 18px | 1.3 | 7px | 78px |
| 本文 | 13px | — | — | — |
| 補助 | 12px | — | — | — |
| 注記 | 11px | — | — | — |
...
小さいラベルを見出しの上に置く型を 4箇所で使っている（見出し7箇所のうち）。
...
.c-head__label{ font-size:11px; font-weight:400;
  color:#95b300 }
.c-head__title{ font-size:18px; line-height:1.3; margin-top:7px }
.c-head__title + *{ margin-top:78px }
```

- ラベルと見出しの間は 7px、見出しと本文の間は 78px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:11px; font-weight:400; color:#95b300 }
.c-head__title{ font-size:18px; line-height:1.3; margin-top:7px }
.c-head__title + *{ margin-top:78px }
