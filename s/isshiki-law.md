...
```css
.c-head__label{ font-size:12px; font-weight:400; letter-spacing:0.15em;
  color:#444444; text-transform:uppercase }
.c-head__title{ font-size:24px; line-height:1.5; margin-top:7px }
.c-head__title + *{ margin-top:40px }
```

- ラベルと見出しの間は 7px、見出しと本文の間は 40px。ラベル側を詰めて、本文側を空ける。この差がまとまりを作っている。
...
.c-head__label{ font-size:12px; font-weight:400; letter-spacing:0.15em; color:#444444 }
.c-head__title{ font-size:24px; line-height:1.5; margin-top:7px }
.c-head__title + *{ margin-top:40px }
