...
| 用途 | サイズ | 行間 | 上の余白 | 下の余白 |
|---|---|---|---|---|
| 大見出し | 55px | 1.5 | 13px | 27px |
| 見出し | 28px | 1.5 | 134px | 16px |
| 小見出し | 20px | — | 213px | 8px |
| 本文 | 16px | 1.5 | 256px | 20px |
| 補助 | 14px | — | 60px | 58px |
| 注記 | 12px | — | — | — |
...
```css
.c-head__label{ font-size:16px; font-weight:600; letter-spacing:0.07em;
  color:#688177; text-transform:uppercase }
.c-head__title{ font-size:38px; margin-top:40px }
.c-head + *{ margin-top:40 }
```

- ラベルと見出しの間は 40px、見出しと本文の間は —。この2つを同じにしない。
...
.c-head__label{ font-size:16px; font-weight:600; letter-spacing:0.07em; color:#688177 }
.c-head__title{ font-size:38px; margin-top:40px }
