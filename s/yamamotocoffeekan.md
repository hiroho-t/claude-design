...
- 使われている面の色: `#ffffff`（19） / `#e4dad3`（16） / `#f8f5f3`（2）
- 見出しは左1／中央3。
...
角丸は 0px だが、**完全な円は別扱い**で 35 箇所ある（40px×27、32px×6、48px×2）。
アイコンの地・点・装飾に使う。角を丸めないルールと、円のモチーフは両立する。

## 画像

- 37枚使っている。うち 2 枚は画面いっぱいに置く
- 比率は 1:1（26枚）、4:3（5枚）、3:2（3枚）
- 角丸 0px。切り抜かず四角のまま置く
