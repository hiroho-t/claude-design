...
|---|---|---|---|---|
| 大見出し | 160px | — | — | — |
| 見出し | 42px | 1.5 | 26px | 16px |
| 小見出し | 28px | — | — | — |
| リード | 16px | — | — | — |
| 本文 | 14px | 1.8 | 63px | 42px |
| 補助 | 13px | — | — | — |
...
```css
.c-head__label{ font-size:14px; font-weight:600; letter-spacing:0.1em;
  color:#ffffff }
.c-head__title{ font-size:42px; line-height:1.5; margin-top:26px }
.c-head__title + *{ margin-top:16px }
```

- ラベルと見出しの間は 26px、見出しと本文の間は 16px。この2つを同じにしない。
...
.c-head__label{ font-size:14px; font-weight:600; letter-spacing:0.1em; color:#ffffff }
.c-head__title{ font-size:42px; line-height:1.5; margin-top:26px }
.c-head__title + *{ margin-top:16px }
